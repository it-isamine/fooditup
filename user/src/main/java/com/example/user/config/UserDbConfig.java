...
@Configuration
@EnableJpaRepositories(basePackages = "com.example.user.repo.user", // Replace with your repository package
        entityManagerFactoryRef = "userEntityManagerFactory", transactionManagerRef = "userTransactionManager")
@EntityScan(basePackages = "com.example.user.model.user")
public class UserDbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emFactoryBean.setPackagesToScan("com.example.user.model.user"); // Adjust to your package containing entities
