...
@Configuration
@EnableJpaRepositories(basePackages = "com.example.user.repo.admin", // Replace with your repository package
        entityManagerFactoryRef = "adminEntityManagerFactory", transactionManagerRef = "adminTransactionManager")
@EntityScan(basePackages = "com.example.user.model.admin")
public class AdminDbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emFactoryBean.setPackagesToScan("com.example.user.model.admin"); // Adjust to your package containing entities
